<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-12 flex flex-row gap-12 text-gray-200">
        ...
        <div class="w-1/4 flex flex-col gap-6 font-medium text-center mt-14">
            ...
            <a href="{{ route('favorites.index') }}" class="bg-white text-black py-2 px-4 rounded-xl shadow-lg font-semibold">Favorite Movies</a>
            
            <a href="{{ route('watchlist.index') }}" class="text-gray-300 hover:text-white transition">Watchlist</a>
        ...
        <div class="w-3/4">
            <div class="flex justify-between items-center mb-8">
                <h2 class="text-3xl font-bold text-white tracking-wide">Movies</h2>
